...
* @date 2020年5月19日
*/
public class LuckySheetCompareRateCalculate extends Calculate<LuckySheetBindData>{
	...
	public String calculate(LuckySheetBindData bindData) {
		...
		if(result2.compareTo(new BigDecimal(0)) == 0) {
			...
			result = result1.subtract(result2).divide(result2,bindData.getDigit(),RoundingMode.HALF_UP);
		}
