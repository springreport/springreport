...
<div>
  <el-header class="_header df-c-b">
    <div class="left df-c">
      ...
      />
      <img src="@/static/img/logo.png" height="24px" v-show="navShow" style="margin-left:20px" />
    </div>
  ...
  <modal
        ref="changePwd"
        :modalConfig="changePwdConfig"
        :modalForm="changePwdForm"
        :modalData="changePwdModalData"
        :modalHandles="changePwdModalHandles"
