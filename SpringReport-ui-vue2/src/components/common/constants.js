...
commonConstants.screenMapInit = {
  ...
  isTable: false, // 是否显示表格
  tableHeight: 395, // 表格高度
  tableWidth: 150, // 表格宽度
  tableColumn: [{ 'name': '地区名称', 'key': 'name', 'style': { 'width': '40' }}, { 'name': '数量', 'key': 'value', 'style': { 'width': '40' }}],
  headStyle: {
    height: 40, // 高度
    backgroundColor: '#2570a1',
    color: '#00FFFF', // 字体颜色
...
commonConstants.screenVideoInit = {
  ...
  loop: true, // 循环播放
  muted: true, // 是否静音
  src: 'https://media.vued.vanthink.cn/sparkle_your_name_am360p.mp4', // 视频
  volume: 0, // 音量
  cover: '', // 封面
  title: '' // 标题
}
