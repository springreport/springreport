...
screenConstants.compType = {
  ...
  basicMap: { text: '基础地图', icon: 'map' },
  scatterMap: { text: '散点地图', icon: 'map' },
...
screenConstants.comboChartType = [
  ...
  { 'name': 'tableMap', 'text': '地图表格', 'src': `${process.env.VUE_APP_BASE_URL_PREFIX}`+'/images/chart/tableMap.png', category: screenConstants.category.tableMap },
]
...
screenConstants.formsType = [
  { 'name': 'formsDate', 'text': '日期时间', 'src': `${process.env.VUE_APP_BASE_URL_PREFIX}`+'/images/chart/formstime.png', category: screenConstants.category.forms },
  { 'name': 'formsDateRange', 'text': '日期范围', 'src': `${process.env.VUE_APP_BASE_URL_PREFIX}`+'/images/chart/formstimerange.png', category: screenConstants.category.forms },
  { 'name': 'formsSelect', 'text': '下拉单选', 'src': `${process.env.VUE_APP_BASE_URL_PREFIX}`+'/images/chart/formsselect.png', category: screenConstants.category.forms },
  { 'name': 'formsMultiselect', 'text': '下拉多选', 'src': `${process.env.VUE_APP_BASE_URL_PREFIX}`+'/images/chart/formsmultiselect.png', category: screenConstants.category.forms },
