    ...
    >
      <div class="el-dialog-div">
        ...
        >
          ...
          >
            <el-input v-model="paramForm.paramName" placeholder="参数名称" />
          </el-form-item>
          <el-form-item
            label="参数编码"
            prop="paramCode"
          ...
          >
            <el-input v-model="paramForm.paramCode" placeholder="参数编码" />
          </el-form-item>
          <el-form-item
            label="参数前缀"
            prop="paramPrefix"
          ...
          <el-form-item label="默认值">
            <el-input v-model="paramForm.paramDefault" placeholder="默认值" />
          </el-form-item>
          ...
          <el-form-item>
            ...
            <el-tag
              v-show="paramForm.paramType == 'select'"
              type="primary"
        ...
        if (valid) {
          ...
          if (this.component.params) {
            if (this.isEdit) {
              ...
              this.component.params[this.editIndex].paramPrefix =
                this.paramForm.paramPrefix
              this.component.params[this.editIndex].dateFormat =
                this.paramForm.dateFormat
              this.component.params[this.editIndex].isRelyOnParams =
                this.paramForm.isRelyOnParams
              this.component.params[this.editIndex].relyOnParams =
                this.paramForm.relyOnParams
              this.component.params[this.editIndex].checkStrictly =
