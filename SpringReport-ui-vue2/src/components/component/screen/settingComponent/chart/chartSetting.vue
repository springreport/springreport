            ...
            <el-collapse-item title="图表设置">
                <el-form class="demo-form-inline" :inline="true" :model="component" label-position="left" size="mini" ref="settingForm">
                    ...
                    <el-form-item label="" v-for="(item,index) in component.spec.color" :key="index" >
                        <el-color-picker v-model="component.spec.color[index]" size="mini" @change="commonUtil.reLoadChart(chartsComponents,component)"></el-color-picker><br>
                    ...
                    <el-form-item label="" v-for="(item,index) in component.spec.color.range" :key="index" >
                        <el-color-picker v-model="component.spec.color.range[index]" size="mini" @change="commonUtil.reLoadChart(chartsComponents,component)"></el-color-picker><br>
                        <el-button @click="confirmDeleteMapColor(index)" type="primary" size="mini" icon="el-icon-delete" circle></el-button>
