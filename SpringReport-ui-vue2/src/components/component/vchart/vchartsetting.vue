...
<template>
    <div>
                <el-form class="demo-form-inline" :inline="true" :model="component" label-position="left" size="mini" ref="settingForm" >
                    ...
                    <el-form-item label="">
                        <el-button-group>
                        <el-button type="primary" size="mini" @click="addColor(component)">添加<i class="el-icon-plus el-icon--right"></i></el-button>
                         <el-button type="danger" size="mini" @click="clearColor(component)">清空<i class="el-icon-delete el-icon--right"></i></el-button>
                        </el-button-group>
                    </el-form-item>
                    ...
                    <el-form-item label="" v-for="(item,index) in component.defaultOption.spec.color" :key="index" >
                        <el-color-picker v-model="component.defaultOption.spec.color[index]" size="mini" @change="reLoadChart()"></el-color-picker><br>
                        <el-button @click="confirmDeleteColor(index)" type="primary" size="mini" icon="el-icon-delete" circle></el-button>
                    ...
                    <div v-if="component.chartAllType.toLowerCase().indexOf('pie')>=0">
                        <el-form-item label="饼图设置" class="customLabel">
                         ...
                         <el-form-item label="外半径(0-1)">
                             <el-button type="text" icon="el-icon-minus" @click="radiusMiuns('1')"></el-button>
                            <el-input style="width:100px"  @change="changeRadius('1')" v-model="component.defaultOption.spec.outerRadius"></el-input>
                             <el-button type="text" icon="el-icon-plus" @click="radiusPlus('1')"></el-button>
                        </el-form-item>
                        <el-form-item label="内半径(0-1)">
                             <el-button type="text" icon="el-icon-minus" @click="radiusMiuns('2')"></el-button>
                            <el-input style="width:100px"  @change="changeRadius('2')" v-model="component.defaultOption.spec.innerRadius"></el-input>
                             <el-button type="text" icon="el-icon-plus" @click="radiusPlus('2')"></el-button>
                        </el-form-item>
        ...
        <el-dialog title="添加" :visible.sync="addColorDialogVisiable" :close-on-click-modal='false' @close='closeAddDialog'>
             <el-form :inline="true" class="demo-form-inline" ref="addColorRef" size="mini">
...
<script>
import InputColorPicker from '../../component/screen/colorpicker/inputColorPicker.vue'
