...
<template>
  <div>
      ...
      <el-collapse v-model="formCollapse">
        <el-collapse-item title="常规配置" name="generalConfig">
          ...
          <div v-if="!isPreview">
            <div
              ...
              @click="dataSetOpen = !dataSetOpen"
            >
              <span>数据设置</span>
              <i
                :class="dataSetOpen ? 'el-icon-arrow-up' : 'el-icon-arrow-down'"
              />
            </div>
            <div v-show="dataSetOpen" class="cus-collapse-content">
              <el-form-item label="行列转置">
                <el-switch
                  v-model="component.rangeConfigCheck"
                  @change="rowColTrans()"
                />
              </el-form-item>
              <el-form-item
            ...
            <div
              v-show="component.defaultOption.spec.title.visible"
        ...
        <el-collapse-item title="图表装修" name="chartStyle">
          ...
          <div v-show="setWidthAndHeightOpen" class="cus-collapse-content">
            ...
            >
              ...
              <el-form-item class="df-form-item" label="圆角">
                <el-input
            ...
            >
              ...
              <el-form-item class="df-form-item" label="区域显示">
                <el-switch
                  v-model="component.defaultOption.spec.area.visible"
                  @change="reLoadChart()"
                /> </el-form-item><br>
              <el-form-item class="df-form-item" label="圆形网格">
                <el-switch
              ...
              <el-form-item class="df-form-item" label="坐标轴颜色">
                <input-color-picker
                  ...
                  "
                /> </el-form-item><br>
              <el-form-item class="df-form-item" label="轴标签颜色">
                <input-color-picker
                  :input-width="140"
          ...
          <el-form-item label="背景颜色">
            <input-color-picker :value="component.defaultOption.spec.background" @change="(val)=>{component.defaultOption.spec.background=val;reLoadChart()}" />
          </el-form-item>
        ...
        <el-collapse-item title="标签设置" name="labelSet">
          <el-form-item label="是否显示" class="df-form-item">
            <el-switch
              v-model="component.defaultOption.spec.label.visible"
              @change="reLoadChart()"
            />
          </el-form-item>
          <el-form-item
    ...
    <el-dialog
      title="添加"
      :visible.sync="addColorDialogVisiable"
...
export default {
  ...
  methods: {
    ...
    getColorLabel() {
      const type = this.component.chartAllType.toLowerCase()
      let label = ''
    ...
    formatterRule() {
      window.open(
        'https://www.visactor.io/vchart/guide/tutorial_docs/Chart_Plugins/Formatter'
      )
    },
    changeRadarColor(chartsComponents, component) {
    ...
    getChartType() {
      const chartAllType = this.component.chartAllType
