    ...
    return {
      ...
      pageData: {
        ...
        tableHandles: [
          ...
          { label: '导出模板', type: 'warning', position: 'right', iconClass: 'el-icon-download', handle: () => this.exportTemplate(), auth: 'exceltemplate_export' },
          { label: '导入模板', type: 'danger', position: 'right', iconClass: 'el-icon-upload2', handle: () => this.importTemplate(), auth: 'exceltemplate_import' },
