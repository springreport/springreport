    ...
    <div class="pagebox">
        <div class="header">
            <div class="left">
                ...
                <div class="svg-box" @click="clickShow('isShowLayer')">
                    <svg-icon icon-class="layer" class="svg" />
                </div>
                </el-tooltip>
                <!-- 面板 -->
                ...
                <div class="svg-box" style="margin-left:6px" @click="clickShow('isShowConf')">
                    <svg-icon icon-class="panel" class="svg" />
                </div>
                </el-tooltip>
            </div>
            <div class="middle">
                <svg-icon icon-class="screen" class="svg" />
            ...
            <div class="right">
                ...
                <div class="svg-box" @click="save()">
                    <svg-icon icon-class="public" class="svg" />
                </div>
                </el-tooltip>
                <!-- 预览 -->
                ...
                <div class="svg-box" style="margin-left:6px" @click="preview()">
                    <svg-icon icon-class="preview" class="svg" />
                </div>
                </el-tooltip>
            </div>
        </div>
        <div class="contentbox">
            ...
            <div class="layer-main">
                ...
                >
                    <div v-if="!item.isDelete && screenConstants.compType[item.type]" class="img-box">
                      <svg-icon :icon-class="screenConstants.compType[item.type].icon" class="svg" />
                    </div>
                    ...
                    <vuedraggable class="wrapper" :sort= "false" :disabled= "false">
                        <div  v-for="(item,index) in subComponents" class="box" @click="addComponent(item)" :key="index" @dragend="endDraggable(item)">
                                <el-popover  v-if="item.name != 'picture'"
                                    ...
                                    <p slot="reference" >{{item.text}}</p>
                                </el-popover>
                                <p v-if="item.name == 'picture'" slot="reference" >{{item.text}}</p>
                        </div>
                    </vuedraggable>
                </div>
            </div>
          ...
          <div ref="dragContainer" class="mainbox">
            ...
            <div  class="scaleWrap">
                <el-select v-model="scaleSelected" size="mini" :popper-append-to-body="false" class="select" style="width:80px">
