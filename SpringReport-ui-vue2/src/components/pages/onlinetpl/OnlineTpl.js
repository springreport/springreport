      ...
      pageData:{
        ...
        tableCols:[
					...
					{label:'操作',prop:'operation',align:'center',type:'button',btnList:[
						{label:'查看',type:'text',auth:'onlineTpl_getDetai',handle:(row)=>this.showModal(this.commonConstants.modalType.detail,row.id)},
						{label:'编辑',type:'text',auth:'onlineTpl_update',handle:(row)=>this.showModal(this.commonConstants.modalType.update,row.id)},
            {label:'编辑文档',type:'text',auth:'onlineTpl_editDoc',handle:(row)=>this.routerTo(row)},
						{label:'删除',type:'text',auth:'onlineTpl_delete',handle:(row)=>this.deleteOne(row.id)},
					]}
        ],
        //表格列表头end
        //modal配置 start
