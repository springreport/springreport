...
| 序号 | 收费内容                                   | 价格     | 备注                                                                 |
|------|--------------------------------------------|----------|----------------------------------------------------------------------|
| 1    | 去除水印 + 商用授权                        | ¥10999   | 仅去水印和商用授权，不提供luckysheet的源码                                     |
...
| 11   | SpringReport-AI，接入deepseek插件          | 赠品     | 购买全部源码即赠（原价 ¥4999）                                     |
| 12   | 全部内容（原价 ¥53000+）                   | ¥29999   | 全源码交付，永久免费升级，无项目数量限制                             |
| 13   | 国际化版本全源码                           | 单独报价 | 独立代码，无法从开源版升级                                           |
...
## 侵权黑名单
### 黑名单内企业均存在侵权使用 SpringReport的行为。若贵司与这类企业有业务合作，请务必核查报表类项目，严禁违规使用 SpringReport，规避侵权风险及相关经济损失。
### 所有付费用户，禁止与黑名单企业开展任何涉及 SpringReport 的项目合作；同时，黑名单企业后续若需采购授权，不再适用官网统一售价及常规优惠政策。
