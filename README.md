...
| 8  | 自定义函数插件  | 不开源  | 需要请与作者联系  |
| 9  | 模板导出导入功能  | 不开源  | 需要请与作者联系  |
| 10 | 多大屏功能  | 不开源  | 需要请与作者联系  |
### 为了项目的可持续发展，目前有以下几部分内容是收费的，收费内容都是统一价格，没有优惠，还请理解
### 注：付费部分只是提供源码，如果没有源码也完全不会影响使用，根据自己的需要选择是否购买即可
| 序号  | 收费内容  | 价格  | 备注  |
|---|---|---|---|
| 1 | 去除水印+商用授权  | ¥10499(含税)  | 只是去掉水印，不提供以下内容的源代码，如果对水印没有要求的可以忽略 |
| 2 | luckysheet优化后的源代码+去除水印+商用授权   | ¥14999(含税)  | 如果不需要对luckysheet进行二次开发的话没必要购买源码，没有源码对使用完全没有影响 |
...
| 8 | 模版导出导入插件| 非卖品，赠品(¥3499)  | 购买任何一项付费内容赠送该功能，已付费的用户费可直接与作者联系 |
| 9 | 多大屏功能插件| 非卖品，赠品(¥1999)  | 购买任何一项付费内容赠送该功能，已付费的用户费可直接与作者联系 |
| 10 | 以上全部内容(原价51000+)| ¥29999(含税)  |全部源码交付，永久免费升级，没有项目数量限制 |
