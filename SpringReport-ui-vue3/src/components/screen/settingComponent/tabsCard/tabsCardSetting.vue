    ...
    >
      ...
      <div class="right-dataset-title df-c-b">
        <span class="attr-dataset-title">标签内容</span>
         <el-button type="primary" size="default" class="addBtn" @click="addTab(component)"
                ><icon-plus
                  theme="outline"
                  size="16"
                  fill="#FFF"
  ...
  <el-dialog
    ...
    >
      ...
      >
        ...
        >
          <el-input v-model="tabsForm.tabContent" size="default" placeholder="标签名称"/>
        </el-form-item>
        <el-form-item
          label="绑定组件"
...
export default {
  ...
  components: {
    InputColorPicker,
    subSettings: defineAsyncComponent (()=> import('../../settings/settings.vue'))
  },
  props: {
    component: {
      type: Object,
