        ...
        <el-collapse>
            <el-collapse-item title="通用设置">
                ...
                <el-form-item label="左">
                    <el-button link type="primary" icon="icon-minus" @click="minusClick('1')"></el-button>
                    <el-input  v-model.number="component.x" style="width:65px" placeholder="左" :disabled="component.locked">
                    </el-input>
                    <el-button link type="primary" icon="icon-plus" @click="plusClick('1')"></el-button>
                </el-form-item>
                <el-form-item label="上">
                    <el-button link type="primary" icon="icon-minus" @click="minusClick('2')"></el-button>
                    <el-input  v-model.number="component.y" style="width:65px" placeholder="上" :disabled="component.locked"></el-input>
                    <el-button link type="primary" icon="icon-plus" @click="plusClick('2')"></el-button>
                </el-form-item>
                <el-form-item label="图表尺寸" class="customLabel">
                </el-form-item><br>
                <el-form-item label="宽">
                    <el-button link type="primary" icon="icon-minus" @click="minusClick('3')"></el-button>
                    <el-input  v-model.number="component.w" style="width:65px" placeholder="宽度" :disabled="component.locked"></el-input>
                    <el-button link type="primary" icon="icon-plus" @click="plusClick('3')"></el-button>
                </el-form-item>
                <el-form-item label="高">
                    <el-button link type="primary" icon="icon-minus" @click="minusClick('4')"></el-button>
                    <el-input  v-model.number="component.h" style="width:65px" placeholder="高度" :disabled="component.locked"></el-input>
                    <el-button link type="primary" icon="icon-plus" @click="plusClick('4')"></el-button>
                </el-form-item>
