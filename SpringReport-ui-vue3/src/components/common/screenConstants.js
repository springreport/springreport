...
screenConstants.textType = [
  {"name":"text","text":"文本","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/text.png",category:screenConstants.category.text},
  {"name":"date","text":"日期时间","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/time.png",category:screenConstants.category.text},
]

screenConstants.numberFlipperType = [
  { 'name': 'numberFlipper', 'text': '数字翻牌器', 'src': import.meta.env.VITE_BASE_URL_PREFIX+'/images/chart/numberflipper.png', category: screenConstants.category.numberFlipper },
]
...
screenConstants.borderType = [
  {"name":"dv-border-box-1","text":"边框1","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/border1.png",category:screenConstants.category.border},
  {"name":"dv-border-box-2","text":"边框2","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/border2.png",category:screenConstants.category.border},
  {"name":"dv-border-box-3","text":"边框3","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/border3.png",category:screenConstants.category.border},
  {"name":"dv-border-box-4","text":"边框4","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/border4.png",category:screenConstants.category.border},
  {"name":"dv-border-box-4","text":"边框4(反向)","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/rborder4.png",category:screenConstants.category.border},
  {"name":"dv-border-box-5","text":"边框5","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/border5.png",category:screenConstants.category.border},
  {"name":"dv-border-box-5","text":"边框5(反向)","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/rborder5.png",category:screenConstants.category.border},
  {"name":"dv-border-box-6","text":"边框6","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/border6.png",category:screenConstants.category.border},
  {"name":"dv-border-box-7","text":"边框7","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/border7.png",category:screenConstants.category.border},
  {"name":"dv-border-box-8","text":"边框8","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/border8.png",category:screenConstants.category.border},
  {"name":"dv-border-box-8","text":"边框8(反向)","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/border8.png",category:screenConstants.category.border},
  {"name":"dv-border-box-9","text":"边框9","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/border9.png",category:screenConstants.category.border},
  {"name":"dv-border-box-10","text":"边框10","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/border10.png",category:screenConstants.category.border},
  {"name":"dv-border-box-11","text":"边框11","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/border11.png",category:screenConstants.category.border},
  {"name":"dv-border-box-12","text":"边框12","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/border12.png",category:screenConstants.category.border},
  {"name":"dv-border-box-13","text":"边框13","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/border13.png",category:screenConstants.category.border},
]
screenConstants.decorationType = [
  {"name":"dv-decoration-1","text":"装饰1","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/decoration1.png",category:screenConstants.category.decoration},
  {"name":"dv-decoration-2","text":"装饰2","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/decoration2.png",category:screenConstants.category.decoration},
  {"name":"dv-decoration-2","text":"装饰2(反向)","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/rdecoration2.png",category:screenConstants.category.decoration},
  {"name":"dv-decoration-3","text":"装饰3","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/decoration3.png",category:screenConstants.category.decoration},
  {"name":"dv-decoration-4","text":"装饰4","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/decoration4.png",category:screenConstants.category.decoration},
  {"name":"dv-decoration-4","text":"装饰4(反向)","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/rdecoration4.png",category:screenConstants.category.decoration},
  {"name":"dv-decoration-5","text":"装饰5","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/decoration5.png",category:screenConstants.category.decoration},
  {"name":"dv-decoration-6","text":"装饰6","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/decoration6.png",category:screenConstants.category.decoration},
  {"name":"dv-decoration-7","text":"装饰7","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/decoration7.png",category:screenConstants.category.decoration},
  {"name":"dv-decoration-8","text":"装饰8","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/rdecoration8.png",category:screenConstants.category.decoration},
  {"name":"dv-decoration-8","text":"装饰8(反向)","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/decoration8.png",category:screenConstants.category.decoration},
  {"name":"dv-decoration-9","text":"装饰9","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/decoration9.png",category:screenConstants.category.decoration},
  {"name":"dv-decoration-10","text":"装饰10","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/decoration10.png",category:screenConstants.category.decoration},
  {"name":"dv-decoration-11","text":"装饰111","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/decoration11.png",category:screenConstants.category.decoration},
]
//柱状图类型
screenConstants.histogramType = [
    {"name":"histogram","text":"柱状图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/histogram.png",category:screenConstants.category.vchart},
    {"name":"stackHistogram","text":"堆叠柱状图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/stackHistogram.png",category:screenConstants.category.vchart},
    {"name":"rangeHistogram","text":"区间柱状图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/rangeHistogram.png",category:screenConstants.category.vchart},
    {"name":"horizontalHistogram","text":"条形图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/horizontalHistogram.png",category:screenConstants.category.vchart},
    {"name":"stackHorizontalHistogram","text":"堆叠条形图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/stackHorizontalHistogram.png",category:screenConstants.category.vchart},
    {"name":"rangeHorizontalHistogram","text":"区间条形图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/rangeHorizontalHistogram.png",category:screenConstants.category.vchart},
] 

screenConstants.lineType = [
    {"name":"line","text":"折线图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/line.png",category:screenConstants.category.vchart},
    {"name":"horizontalLine","text":"垂直折线图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/horizontalLine.png",category:screenConstants.category.vchart},
    {"name":"smoothLine","text":"平滑折线图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/smoothLine.png",category:screenConstants.category.vchart},
    {"name":"stepLine","text":"阶梯折线图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/stepLine.png",category:screenConstants.category.vchart},
    {"name":"stackLine","text":"堆叠折线图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/stackLine.png",category:screenConstants.category.vchart},
] 

screenConstants.areaType = [
    {"name":"area","text":"面积图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/area.png",category:screenConstants.category.vchart},
    {"name":"horizontalArea","text":"垂直面积图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/horizontalArea.png",category:screenConstants.category.vchart},
    {"name":"smoothArea","text":"平滑面积图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/smoothArea.png",category:screenConstants.category.vchart},
    {"name":"stepArea","text":"阶梯面积图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/stepArea.png",category:screenConstants.category.vchart},
    {"name":"stackArea","text":"堆叠面积图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/stackArea.png",category:screenConstants.category.vchart},
] 
screenConstants.pieType = [
    {"name":"pie","text":"饼图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/pie.png",category:screenConstants.category.vchart},
    {"name":"pieRose","text":"玫瑰图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/pieRose.png",category:screenConstants.category.vchart},
] 

screenConstants.scatterType = [
    {"name":"scatter","text":"散点图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/scatter.png",category:screenConstants.category.vchart},
]

screenConstants.radarType = [
    {"name":"radar","text":"雷达图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/radar.png",category:screenConstants.category.vchart},
    {"name":"stackRadar","text":"堆叠雷达图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/stackRadar.png",category:screenConstants.category.vchart}
]

screenConstants.wordCloudType = [
    {"name":"wordCloud","text":"词云图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/wordCloud.png",category:screenConstants.category.vchart},
]

screenConstants.funnelType = [
    {"name":"funnel","text":"漏斗图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/funnel.png",category:screenConstants.category.vchart},
    {"name":"transformFunnel","text":"转化漏斗图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/funnel.png",category:screenConstants.category.vchart},
]

screenConstants.gaugeType = [
    {"name":"gauge","text":"仪表盘","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/gauge.png",category:screenConstants.category.vchart},
    {"name":"tickGauge","text":"刻度仪表盘","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/tickGauge.png",category:screenConstants.category.vchart},
    {"name":"seriesGauge","text":"系列仪表盘","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/seriesGauge.png",category:screenConstants.category.vchart},
    {"name":"tickSeriesGauge","text":"刻度系列仪表盘","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/tickSeriesGauge.png",category:screenConstants.category.vchart},
]

screenConstants.progressType = [
  {"name":"circularProgress","text":"环形进度条","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/circularProgress.png",category:screenConstants.category.vchart},
  {"name":"barProgress","text":"条形进度条","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/linearProgress.png",category:screenConstants.category.vchart},
  {"name":"liquid","text":"水波图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/liquid.png",category:screenConstants.category.vchart},
]

screenConstants.mapType = [
  { 'name': 'basicMap', 'text': '基础地图', 'src': import.meta.env.VITE_BASE_URL_PREFIX+'/images/chart/map.png', category: screenConstants.category.vchart },
  { 'name': 'scatterMap', 'text': '散点地图', 'src': import.meta.env.VITE_BASE_URL_PREFIX+'/images/chart/scatterMap.png', category: screenConstants.category.vchart }
]

screenConstants.tableType = [
  {"name":"scrollTable","text":"轮播列表","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/scrollTable.png",category:screenConstants.category.table},
  {"name":"pageTable","text":"分页列表","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/pageTable.png",category:screenConstants.category.table},
  { 'name': 'cardList', 'text': '卡片列表', 'src': import.meta.env.VITE_BASE_URL_PREFIX+'/images/chart/cardlist.png', category: screenConstants.category.table }
]

screenConstants.boxPlotType = [
  {"name":"boxPlot","text":"箱型图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/boxPlot.png",category:screenConstants.category.vchart},
]

screenConstants.circlePackingType = [
  {"name":"circlePacking","text":"气泡图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/circlePacking.png",category:screenConstants.category.vchart},
]

screenConstants.zhifangtuType = [
  {"name":"zhifangtu","text":"直方图","src":import.meta.env.VITE_BASE_URL_PREFIX+"/images/chart/zhifangtu.png",category:screenConstants.category.vchart},
]

screenConstants.sankeyType = [
  { 'name': 'sankey', 'text': '桑葚图', 'src': import.meta.env.VITE_BASE_URL_PREFIX+'/images/chart/sankey.png', category: screenConstants.category.vchart }
]
