...
MSG_LIST["error.selectdatasource"] = "请选择数据源";
//错误消息end
...
MSG_LIST["warning.auth.noview"] = "您暂时没有该sheet的查看权限，如需权限可联系创建者【{0}】。";
MSG_LIST["warning.sharemode.forbiddendel"] = "分享模式下只允许分享者删除sheet页。";
//警告消息end
