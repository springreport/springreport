      ...
      pageData: {
        ...
        modalForm: [
          ...
          { type: 'Input', label: '电话', prop: 'phone', rules: { required: true, maxLength: 0 } },
          {
            ...
            label: '邮箱',
            prop: 'email',
            rules: { required: true, maxLength: 50, type: 'email' },
          },
          {
            type: 'Radio',
            label: '状态',
