    ...
    <div class="task-right">
      ...
      <div class="task-list">
        <div v-for="item in taskDatas" :key="item.id" class="task-item">
          ...
          <div class="task-item-title overflow-text"> 任务名称：{{ item.jobName }} </div>
          <div class="desc overflow-text"> 任务状态：{{ getTaskStatus(item.triggerState) }} </div>
          <div class="desc overflow-text">所属报表：{{ item.tplName }}</div>
          <div class="desc overflow-text"> 导出类型：{{ getExportTypeName(item.exportType) }} </div>
