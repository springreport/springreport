        ...
        searchHandle: [
          {
            ...
            auth: 'reportDatasourceDictType_search',
          },
          {
            label: '查询',
            type: 'primary',
        ...
        tableHandles: [
          {
            ...
            auth: 'reportDatasourceDictType_insert',
          },
          {
            label: '批量删除',
            type: 'danger',
            ...
            btnList: [
              {
                label: '查看',
                type: 'primary',
                auth: 'reportDatasourceDictType_getDetail',
                handle: (row) => this.showModal(this.commonConstants.modalType.detail, row.id),
              },
              {
                label: '编辑',
                type: 'primary',
                auth: 'reportDatasourceDictType_update',
              ...
              },
              {
                label: '字典值',
                type: 'primary',
                auth: 'reportDatasourceDictType_dictData',
  ...
  methods: {
    ...
    searchtablelist() {
      ...
      var obj = {
        ...
        params: Object.assign(
          { datasourceId: this.$route.query.reportDatasourceId },
    ...
    routerTo(row) {
      ...
      this.$router.push({
        ...
        query: { reportDatasourceId: row.datasourceId, dictType: row.dictType,thirdPartyType:localStorage.getItem(this.commonConstants.sessionItem.thirdPartyType)},
      });
    },
    backTo(){
