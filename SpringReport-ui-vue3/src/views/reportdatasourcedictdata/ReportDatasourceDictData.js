        ...
        tableHandles: [
          {
            ...
            auth: 'reportDatasourceDictData_insert',
          },
          {
            label: '批量删除',
            type: 'danger',
            ...
            btnList: [
              {
                label: '查看',
                type: 'primary',
                auth: 'reportDatasourceDictData_getDetail',
                handle: (row) => this.showModal(this.commonConstants.modalType.detail, row.id),
              },
              {
                label: '编辑',
                type: 'primary',
                auth: 'reportDatasourceDictData_update',
    ...
    searchtablelist() {
      ...
      var obj = {
        ...
        params: Object.assign(
          { datasourceId: datasourceId, dictType: dictType },
