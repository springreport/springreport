<template>
  ...
  >
                  ...
                  <template #item="{ element }">
                    ...
                    >
                      <div
                        ...
                        :title="element.name"
                      >
                        {{ element.name }}<span v-if="datasetItem.datasetType == '2'">({{element.columnName}})</span>
                      <span v-else>({{element.remark}})</span>
                      </div>
                      <div class="action-box df-c">
                        <div
            ...
            <el-collapse v-model="rightFormCollapse">
              <el-collapse-item title="常规配置" name="generalConfig">
                ...
                <!-- <el-form-item label="是否预警" >
                    ...
                    <el-form-item label="预警颜色"  v-show="cellForm.warning">
                        <el-color-picker v-model="cellForm.warningColor"  :predefine="commonConstants.predefineColors" @change="changeWarningColor" :disabled="attrDisabled"></el-color-picker>
                    </el-form-item>
                ...
                <el-form-item label="是否数据字典" class="df-form-item">
                  <el-switch
              ...
              >
                <div class="right-dataset-title df-c-b">
                  ...
                  <el-button class="addBtn" :disabled="attrDisabled" @click="addSubTotalCells"
                ...
                >
                  <el-collapse-item v-for="(o, index) in cellForm.subTotalCells" :key="index">
                    ...
                    <p class="column-tag" style="min-width: 220px; max-width: 220px; margin: 0"
                      >小计类型：{{ commonUtil.getDictionaryValueName('subtotalType', o.type) }}</p
                    >
                    <p
                      class="column-tag"
                      style="min-width: 220px; max-width: 220px; margin: 0"
              ...
              >
                <div class="right-dataset-title df-c-b">
                  ...
                  <el-button
                    v-show="
                      cellForm.isSubtotal &&
                      (!cellForm.subTotalAttrs || cellForm.subTotalAttrs.length == 0)
                    "
                    class="addBtn"
                    :disabled="attrDisabled"
              ...
              <el-collapse-item title="填报配置" name="fillSettings" v-if="tplType != 1">
                ...
                >
                  ...
                  ><icon-plus theme="outline" size="16" fill="#FFF" class="el-icon--left" />添加</el-button>
                </div>
                <el-collapse
                  v-if="
              ...
              <el-collapse-item title="分组小计链" name="groupSubtotal">
                <div class="right-dataset-title df-c-b">
                  ...
                  <el-button class="addBtn" :disabled="attrDisabled" @click="addSubTotalCalc"
                    ><icon-plus
                      theme="outline"
                      size="16"
                      fill="#FFF"
                ...
                <el-collapse
                  v-if="cellForm.subTotalCalc && cellForm.subTotalCalc.length > 0"
                  class="sub-collapse"
                >
              ...
              <el-collapse-item title="单元格过滤条件" name="cellFilter">
                ...
                <div class="right-dataset-title df-c-b">
                  ...
                  <el-button class="addBtn" :disabled="attrDisabled" @click="addCellConditions"
                    ><icon-plus
                      theme="outline"
                      size="16"
                      fill="#FFF"
                ...
                >
                  <el-collapse-item v-for="(o, index) in cellForm.cellconditions" :key="index">
                    ...
                    <p class="column-tag" style="min-width: 220px; max-width: 220px; margin: 0"
                      ...
                      <label v-else-if="o.type == 'number'">数值</label
                      ><label v-else-if="o.type == 'cell'">单元格</label><label v-else>日期</label>
                    </p>
                    <p
                      class="column-tag"
                      :title="o.value"
              ...
              <el-collapse-item title="单元格隐藏条件" name="cellHide">
                ...
                <el-collapse
                  class="sub-collapse"
                  v-if="cellForm.cellHiddenConditions && cellForm.cellHiddenConditions.length > 0"
                >
                  <el-collapse-item
            ...
            <el-collapse v-model="rightFormCollapse2">
              ...
              <el-collapse-item title="循环块配置" name="sheetBlock">
                <div class="right-dataset-title df-c-b">
                  ...
                  <el-button class="addBtn" @click="addBlock"
                    ><icon-plus
                      theme="outline"
                      size="16"
                      fill="#FFF"
                ...
                >
                  <el-collapse-item v-for="(o, index) in sheetBlockData" :key="index">
                    ...
                    <p class="column-tag" style="min-width: 220px; max-width: 220px; margin: 0"
                      >循环块范围：{{ o.startCell }}:{{ o.endCell }}</p
                    >
                    <p class="column-tag" style="min-width: 220px; max-width: 220px; margin: 0"
                      >聚合方式：<label v-if="o.aggregateType == 'list'">列表</label>
              ...
              <el-collapse-item title="sheet页循环配置" name="sheetLoop">
                ...
                <div class="df-c" style="padding: 8px 0 12px 0">
                  <span class="cell-label" style="line-height: 20px">开启循环</span>
                  <el-switch
                    v-model="sheetLoopData.isLoop"
                    active-text="是"
                    inactive-text="否"
        ...
        <div v-show="sqlForm.sqlType == '1' || datasourceType == 2" style="margin-bottom: 20px">
          <div class="parameter-warp">
            ...
            >
              ...
              >
                <el-input v-model="paginationForm.totalAttr" placeholder="总条数属性"></el-input>
              </el-form-item>
            </el-form>
          </div>
        </div>
        <div v-show="sqlForm.sqlType == 1 || datasourceType == 2" style="margin-bottom: 20px">
          <div class="parameter-warp">
            ...
            <el-form label-position="right" :model="paramForm" class="df-form" ref="paramRef">
              ...
              <el-form-item
                v-if="(paramForm.paramType == 'select' || paramForm.paramType == 'mutiselect' || paramForm.paramType == 'treeSelect' || paramForm.paramType == 'multiTreeSelect') && (paramForm.selectType == '2' || paramForm.paramType == 'treeSelect' || paramForm.paramType == 'multiTreeSelect')"
                label="是否依赖其他参数"
                prop="isRelyOnParams"
                key="isRelyOnParams"
    ...
    >
      <el-form label-position="top" :model="blockForm" class="demo-form-inline" ref="blockRef">
        <el-form-item
          label="起始单元格"
          prop="startCell"
          key="startCell"
        ...
        >
          <el-input v-model="blockForm.startCell" placeholder="起始单元格"></el-input>
        </el-form-item>
        <el-form-item
          label="结束单元格"
          prop="endCell"
        ...
        >
          <el-input v-model="blockForm.endCell" placeholder="结束单元格"></el-input>
        </el-form-item>
        <el-form-item
          label="聚合方式"
          prop="aggregateType"
        ...
        >
          <el-select placeholder="聚合方式" v-model="blockForm.aggregateType">
            <el-option label="列表" value="list"></el-option>
            <el-option label="分组" value="group"></el-option>
          </el-select>
        </el-form-item>
    ...
    <el-dialog
      title="单元格隐藏"
      v-model="cellHiddenConditionVisiable"
      width="30%"
      :close-on-click-modal="false"
    ...
    >
      ...
      >
        ...
        <el-form-item
          ...
          :rules="filter_rules('参数编码', { required: true })"
        >
          <el-input v-model="cellHiddenConditionForm.property" placeholder="参数编码"></el-input>
        </el-form-item>
        <el-form-item
          label="操作符"
          prop="operator"
          ...
          :rules="filter_rules('操作符', { required: true })"
        >
          <el-select placeholder="操作符" v-model="cellHiddenConditionForm.operator">
            <el-option
              v-for="op in selectUtil.operate"
              :label="op.label"
              :value="op.value"
        ...
        <el-form-item
          ...
          :rules="filter_rules('数据类型', { required: true })"
        >
          <el-select placeholder="数据类型" v-model="cellHiddenConditionForm.type">
            <el-option
        ...
        <el-form-item
          ...
          :rules="filter_rules('日期格式', { required: false })"
        >
          <el-select placeholder="日期格式" v-model="cellHiddenConditionForm.dateFormat">
            <el-option
              v-for="op in selectUtil.dateFormat2"
              :label="op.label"
              :value="op.value"
      ...
      <template #footer>
        <span class="dialog-footer">
          <el-button @click="closeCellHiddenConditionDialog">取 消</el-button>
          <el-button type="primary" @click="confirmAddCellHiddenCondition">确 定</el-button>
        </span>
      </template>
    </el-dialog>
    <el-dialog
      title="x轴属性"
      v-model="xAxisVisiable"
      :close-on-click-modal="false"
    ...
    >
      <el-form :inline="true" :model="xAxisForm" class="demo-form-inline" ref="xAxisRef">
        <el-form-item label="图表" prop="chartId" :rules="filter_rules('图表', { required: true })">
          <el-select placeholder="图表" v-model="xAxisForm.chartId" @change="getChartTile()">
            <el-option
        ...
        >
          <el-select placeholder="数据来源" v-model="xAxisForm.dataType">
            <el-option
        ...
        >
          <el-select placeholder="数据集" v-model="xAxisForm.datasetId" @change="getDatasetAttrs()">
            <el-option
        ...
        >
          <el-select placeholder="数据集属性" v-model="xAxisForm.attr">
            <el-option
      ...
      <template #footer>
        <span class="dialog-footer">
          <el-button @click="closexAxisData">取 消</el-button>
          <el-button type="primary" @click="confirmAddxAxisData">确 定</el-button>
        </span>
      </template>
    </el-dialog>
    <el-dialog
      title="单元格小计"
      v-model="cellSubTotalVisiable"
      width="30%"
      :close-on-click-modal="false"
    ...
    >
      ...
      >
        ...
        >
          <el-input v-model="cellSubTotalForm.coords" placeholder="单元格,例如A1"></el-input>
        </el-form-item>
        <el-form-item
          label="小计类型"
          prop="type"
        ...
        >
          <el-select placeholder="小计类型" v-model="cellSubTotalForm.type">
            <el-option
        ...
        <el-form-item label="小数位数" :rules="filter_rules('小数位数', { required: true })">
          <el-input
      ...
      <template #footer>
        <span class="dialog-footer">
          <el-button @click="closeSubtotalDialog">取 消</el-button>
          <el-button type="primary" @click="confirmAddSubtotal">确 定</el-button>
        </span>
      </template>
    </el-dialog>
    <el-dialog
      title="分组小计链"
      v-model="subTotalCalcVisiable"
      width="30%"
      :close-on-click-modal="false"
    ...
    >
      ...
      <template #footer>
        <span class="dialog-footer">
          <el-button @click="closeSubtotalCalcDialog">取 消</el-button>
          <el-button type="primary" @click="confirmAddSubtotalCalc">确 定</el-button>
        </span>
      </template>
    </el-dialog>
    <el-dialog
      title="小计属性"
      v-model="subTotalAttrsVisiable"
      width="30%"
      :close-on-click-modal="false"
    ...
    >
      ...
      >
        ...
        >
          <el-input v-model="subTotalAttrsForm.name" placeholder="小计名称"></el-input>
        </el-form-item>
        <el-form-item
          label="字体颜色"
          prop="fontColor"
        ...
        >
          <el-select placeholder="请选择字体大小" clearable v-model="subTotalAttrsForm.fontSize">
            <el-option
      ...
      <template #footer>
        <span class="dialog-footer">
          <el-button @click="closeSubtotalAttrDialog">取 消</el-button>
          <el-button type="primary" @click="confirmAddSubtotalAttrs">确 定</el-button>
        </span>
      </template>
    </el-dialog>
    <el-drawer
...
<style scoped lang="scss">
  ...
  :deep(.demo-form-inline.el-form--label-top .el-form-item__label) {
    padding-bottom: 0;
    line-height: 32px;
  }

  :deep(.demo-form-inline .el-select),
  :deep(.demo-form-inline .el-textarea),
