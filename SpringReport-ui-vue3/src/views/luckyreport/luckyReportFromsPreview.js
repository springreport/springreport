                    ...
                    this.commonUtil.doPost(obj,headers) .then(response=>{
                        if (response.code == "200")
                        {
                            ...
                            {//显示工具栏
                                ...
                                if(this.searchHandle.length == 2)
                                {
                                    this.searchHandle.push({label:'上报数据',icon:'icon-save-one',type:'success',handle:()=>this.submitDatas(),size:'small'},);
                                    this.searchHandle.push({label:'上报记录',icon:'icon-history',type:'danger',handle:()=>this.getSubmitHis(),size:'small'},);
                                }
                            }
