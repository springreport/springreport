    ...
    <div :style="{ flex: 1, display: 'flex', height: designHeight + 'px' }">
      <div class="left">
        ...
        <div class="left-dataset-title">
          ...
          <el-button class="addBtn" @click="addDataSets" v-has="'reportDesign_addDataSet'"
            >添加<icon-plus theme="outline" size="16" fill="#FFF" class="el-icon--right"
          /></el-button>
        </div>
            ...
            >
              <template #item="{ element }">
                <div
                  class="column-tag"
                  :title="element.name"
                  @dragend="endDraggable(o.datasetName, element.name)"
                  ><icon-copy @click="copyColumn(o.datasetName, element.name)" />{{
                    element.name
                  }}</div
                >
              </template>
        ...
        <div class="right-form">
          ...
          >
            ...
            <el-form-item
              label="分组单元格是否合一"
              size="small"
              v-show="cellForm.aggregateType == 'group' || cellForm.aggregateType == 'groupSummary'"
            >
              <el-switch
            ...
            <el-form-item
              ...
              size="small"
              v-show="
                (cellForm.aggregateType == 'summary' || cellForm.aggregateType == 'groupSummary') &&
                cellForm.dataFrom != 4
              "
            >
              <el-select
            ...
            <div class="right-dataset-title" v-show="cellForm.isSubtotal">
              ...
              <el-button class="addBtn" @click="addSubTotalCells" :disabled="attrDisabled"
                >添加<i class="el-icon-plus el-icon--right"></i
              ></el-button>
            </div>
            <el-collapse
              v-if="
                cellForm.isSubtotal && cellForm.subTotalCells && cellForm.subTotalCells.length > 0
              "
            >
            ...
            <el-collapse
              v-if="
                cellForm.isSubtotal && cellForm.subTotalAttrs && cellForm.subTotalAttrs.length > 0
              "
            >
            ...
            <div class="right-dataset-title">
              ...
              <el-button class="addBtn" @click="addSubTotalCalc" :disabled="attrDisabled"
                >添加<icon-plus theme="outline" size="16" fill="#FFF" class="el-icon--right"
              /></el-button>
            </div>
            ...
            <el-collapse v-if="cellForm.cellconditions && cellForm.cellconditions.length > 0">
              <el-collapse-item v-for="(o, index) in cellForm.cellconditions" :key="index">
                ...
                <p class="column-tag" style="min-width: 220px; max-width: 220px; margin: 0"
                  ...
                  ><label v-else-if="o.type == 'cell'">单元格</label><label v-else>日期</label></p
                >
                <p
                  class="column-tag"
                  :title="o.value"
            ...
            <div class="right-dataset-title">
              ...
              <el-button class="addBtn" @click="addCellHiddenConditions" :disabled="attrDisabled"
                >添加<icon-plus theme="outline" size="16" fill="#FFF" class="el-icon--right"
              /></el-button>
            </div>
            <el-radio
      ...
      <el-tabs type="border-card">
          ...
          <div>
            <el-form :inline="true" :model="sqlForm" class="demo-form-inline" ref="sqlRef">
              ...
              <el-form-item label="系统变量">
                <p
                  ...
                  :key="index"
                  ><icon-copy @click="doCopy(item)" />{{ item.label }}({{ item.value }})</p
                >
              </el-form-item>
            </el-form>
            ...
            <div style="height: 25px" v-if="datasourceType == 1">
              <el-tooltip
                ...
                placement="bottom"
                ><el-tag type="success" @click="execSql" size="small" style="cursor: pointer"
                  ><icon-play />执行</el-tag
                ></el-tooltip
              >
              <el-tooltip content="该操作会将sql语句进行格式化并显示" placement="right"
                ><el-tag @click="formatSql" size="small" style="cursor: pointer"
        ...
        <el-tab-pane label="参数配置">
          <div v-show="sqlForm.sqlType == '1' || datasourceType == 2">
            <el-divider content-position="left" v-if="datasourceType == 1 || datasourceType == 2"
              >分页参数</el-divider
            >
            <el-form
              :inline="true"
              ...
              >
                ...
                <el-table-column label="操作" align="center">
                  <template #default="scope">
                    <el-button @click="editParam(scope.row)" type="primary" text size="small"
                      >编辑</el-button
                    >
                    <el-button @click="moveUp(scope.$index, '3')" type="primary" text size="small"
                      >上移</el-button
                    >
                    <el-button @click="moveDown(scope.$index, '3')" type="primary" text size="small"
                      >下移</el-button
                    >
                    <el-button @click="deleteParam(scope.$index)" type="primary" text size="small"
                      >删除</el-button
                    >
                  </template>
                </el-table-column>
          ...
          <div v-show="sqlForm.sqlType == 2 && datasourceType == 1">
            ...
            <div style="height: 40%">
              ...
              >
                ...
                <el-table-column fixed="right" label="操作" width="180" align="center">
                  <template #default="scope">
                    <el-button @click="editInParam(scope.row)" type="primary" size="small" text
                      >编辑</el-button
                    >
                    <el-button @click="moveUp(scope.$index, '1')" type="primary" size="small" text
                      >上移</el-button
                    >
                    <el-button @click="moveDown(scope.$index, '1')" type="primary" size="small" text
                      >下移</el-button
                    >
                    <el-button @click="deleteInParam(scope.$index)" type="primary" size="small" text
                      >删除</el-button
                    >
                  </template>
                </el-table-column>
            ...
            <div style="height: 30%">
              ...
              >
                ...
                <el-table-column fixed="right" label="操作" width="180" align="center">
                  <template #default="scope">
                    <el-button @click="editOutParam(scope.row)" type="primary" size="small" text
                      >编辑</el-button
                    >
                    <el-button @click="moveUp(scope.$index, '2')" type="primary" size="small" text
                      >上移</el-button
                    >
                    <el-button @click="moveDown(scope.$index, '2')" type="primary" size="small" text
                      >下移</el-button
                    >
                    <el-button
    ...
    >
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button type="primary" @click="confirmAddCellHiddenCondition" size="small"
            >确 定</el-button
          >
        </span>
      </template>
