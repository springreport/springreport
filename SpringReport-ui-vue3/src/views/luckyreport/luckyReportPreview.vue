...
<template>
        ...
        <div class="contentbox" v-loading="loading"  :element-loading-text="loadingText">
            <div class="mainbox" style="height: 100%;display: flex;flex-direction: column;">
              ...
              <div style="width: 100%;flex: none;overflow:auto">
                   <reportForm v-if="showReportForm && showSearch" ref="reportRef" :reportName="tplName" :reportForm="reportForm" :searchData="searchData" :searchHandle="searchHandle" :activitiName="activitiName"  v-model:showSearch="showSearch" :isParamMerge="isParamMerge"  :isDrill="isDrill">
                  </reportForm>
              </div>
                 <div id="right" style="width:100%;flex:1;overflow: auto;">
                   <div  class="config-panel" v-if="chartSettingShow">
                    ...
                    <el-button ref="confirmPrintBtn" id="confirmPrintBtn" v-print="'#print_html'" v-show="false"></el-button>
                 </div>
            </div>
        </div>
    </div>
    <modal ref="modalRef" :modalConfig='modalConfig' 
       ...
       <el-dialog title="指定分页" v-model="pageDialogVisiable" width="50%" :close-on-click-modal='false' @close='closePageDialog'>
        ...
        <el-dialog title="指定分页" v-model="pdfPageDialogVisiable" width="50%" :close-on-click-modal='false' @close='closePdfPageDialog'>
