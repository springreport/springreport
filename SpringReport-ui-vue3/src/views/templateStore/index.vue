...
<template>
  <div class="template-store">
    ...
    <div class="template-type df-c-c">
      ...
      >
        <img class="img" :src="getImageUrl(item.img)" alt="" />
    ...
    <div class="container">
      ...
      <div>
        <el-row :gutter="24">
              ...
              <div class="tem-item">
                <div class="tem-item-img df">
                  ...
                  <div v-else class="default-box">
                    <img :src="getImageUrl(`${searchForm.temType}-default.png`)" />
                  </div>
                </div>
          ...
          <el-empty v-else description="暂无模板" :span="24" style="margin: auto" />
        </el-row>
      </div>
      ...
      <div v-if="temList.length" class="ces-pagination df-c-c" style="margin-bottom: 96px">
        <el-pagination
          ...
          v-model:total="tablePage.pageTotal"
...
<script>
  ...
  export default {
    ...
    methods: {
      getImageUrl(name) {
        return new URL(`../../assets/img/template/${name}`, import.meta.url).href;
      },
      ...
      getReportType() {
        ...
        this.commonUtil.doPost(obj).then((response) => {
          if (response.code == '200') {
            ...
            this.searchForm.templateField = this.subTypeList[0].id;
          }
        });
      },
      searchtablelist() {
